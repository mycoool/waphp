...
class waConfig{
	static public $config=array(		
		...
		'APP' => array(
				...
				'AUTOLOAD_DIR' => array(),	//自动加载扩展目录，wa2.0添加
				),
		...
		'DB'  => array(								
				...
				'DB_CACHE_TYPE' => 'FileCache',//缓存类型，FileCache或Memcache或SaeMemcache，wa2.0添加
				...
				//memcache配置，可配置多台memcache服务器，wa2.0添加
				'MEM_SERVER' => array( array('127.0.0.1', 11211),  array('localhost', 11211) ),
				'MEM_GROUP' => 'db',
				
				//SaeMemcache配置，wa2.0添加
				'SAE_MEM_GROUP' => 'db',
				
				//数据库主从配置，wa2.0添加
				'DB_SLAVE' => array(),//数据库从机配置，wa2.0添加
		...
		'TPL' => array(
				...
				'TPL_CACHE_TYPE'=>'',//数据缓存类型，为空或Memcache或SaeMemcache，其中为空为普通文件缓存，wa2.0添加
